...
public class IsLandUI extends JFrame implements Serializable {
	...
	JLabel lblIsLand, lblIco, lblIconH1, lblIconH2, lblIconH3, lblIconH4, lblIconH5, lblIconH6, lblIconH7, lblIconH8,
			lblIconH9, lblIconH10, lblIconH11, lblIconH12, lblIconH13, lblIconH14, lblIconH15, lblIconH16, lblIconH17;
	...
	public void addEvents() {
		...
		btn6.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH6;
				currentHouse.setName(txt6.getText());
				houseInfoUI.showWindow();
			}
		});
		btn7.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH7;
				currentHouse.setName(txt7.getText());
				houseInfoUI.showWindow();
			}
		});
		btn8.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH8;
				currentHouse.setName(txt8.getText());
				houseInfoUI.showWindow();
			}
		});
		btn9.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH9;
				currentHouse.setName(txt9.getText());
				houseInfoUI.showWindow();
			}
		});
		btn10.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH10;
				currentHouse.setName(txt10.getText());
				houseInfoUI.showWindow();
			}
		});
		btn11.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH11;
				currentHouse.setName(txt11.getText());
				houseInfoUI.showWindow();
			}
		});
		btn12.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH12;
				currentHouse.setName(txt12.getText());
				houseInfoUI.showWindow();
			}
		});
		btn13.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH13;
				currentHouse.setName(txt13.getText());
				houseInfoUI.showWindow();
			}
		});
		btn14.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH14;
				currentHouse.setName(txt14.getText());
				houseInfoUI.showWindow();
			}
		});
		btn15.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH15;
				currentHouse.setName(txt15.getText());
				houseInfoUI.showWindow();
			}
		});
		btn16.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH16;
				currentHouse.setName(txt16.getText());
				houseInfoUI.showWindow();
			}
		});
		btn17.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentLabel = lblIconH17;
				currentHouse.setName(txt17.getText());
				houseInfoUI.showWindow();
			}
		});
	}
